package com.developer.dejavu.custom;
...
/**
 * Custom Class RecyclerView to implement zooming into Gameplay area.
 */
public class ZoomableRecyclerView extends RecyclerView implements View.OnTouchListener {
    ...
    private static final String TAG = ZoomableRecyclerView.class.getClass().getSimpleName();
}
