...
/**
 * CPU Game Logic Activity to handle Two Player Mode, Single Player Mode along with smart CPU component.
 * It basically distinguishes requests with the help of parameters passed in intent.
 */
public class CpuGameActivity extends AppCompatActivity implements OnItemClickListener, GameView, SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Method to handle in case intent is containing info about loading/restoring game state.
