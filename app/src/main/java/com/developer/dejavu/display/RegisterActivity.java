...
/**
 * Activity to manage user registration through firebase
 */
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void registerUser() {
        ...
        /**
         * To create new User for the app using email and password
         */
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //To set display name for the firebase user.
    ...
    /**
     * To sign in user with Provided email and password string values
     * @param email
     * @param password
     */
    ...
    /**
     * Method to sign out current Firebase User.
     */
    ...
    /**
     * Redirects user to Login Activity when attempted sign out
     */
