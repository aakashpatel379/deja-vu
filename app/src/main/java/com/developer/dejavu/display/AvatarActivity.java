...
/**
 * Activity to handle custom Avatar selection
 */
public class AvatarActivity extends AppCompatActivity
{
    ...
    /**
     * Method to load user info if updated User information for the user exists in the database.
     */
    ...
    /**
     * Method to save and update user detail.
     */
